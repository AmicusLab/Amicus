...
- `AMICUS_ADMIN_SESSION_SECRET` - Session signing secret
- `CONFIG_ENCRYPTION_KEY` - Encryption key for secrets storage
- `AMICUS_ADMIN_PASSWORD` - Auto-generated admin password (printed to console)
...
| `CONFIG_ENCRYPTION_KEY` | Encrypt persisted secrets (auto-generated by init) | `<random-base64>` |
| `AMICUS_ADMIN_SESSION_SECRET` | Admin session signing secret (auto-generated by init) | `<random-base64>` |
| `AMICUS_ADMIN_PASSWORD` | Admin login password (auto-generated by init) | `<random-base64>` |

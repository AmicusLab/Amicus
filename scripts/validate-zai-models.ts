 ...
 *
 * Validates all Z.ai models by calling the Tokenizer API.
...
import { ZaiPlugin } from "@amicus/core";
...
/**
 * Validate a single model by calling the Tokenizer API
 */
